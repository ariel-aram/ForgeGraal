/*
 * Data tables for HTTP/2 (node-http2.js): the HPACK static table (RFC 7541 Appendix A), the HPACK Huffman code
 * (Appendix B) and the constants Node exposes as `http2.constants`.
 */

export const HPACK_STATIC = [
	[":authority", ""],
	[":method", "GET"],
	[":method", "POST"],
	[":path", "/"],
...
/* Codes and their bit lengths for the 256 byte values and EOS (index 256). */
export const HUFFMAN_CODES = [
