...
class DenoBundler {
    ...
    static wrap(bundle, entryRel, deno) {
        const shim = (0, node_fs_1.readFileSync)((0, node_path_1.join)((0, node_path_1.dirname)(require.resolve("../../package.json")), "quickjs/runtime/deno-shim.js"), "utf-8")
