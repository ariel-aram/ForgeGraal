...
exports.WASM_FALLBACKS_SOURCE = void 0;
exports.WASM_FALLBACKS_SOURCE = `"use strict";
		...
		try {
			...
			if (isDlopenFail) {
				...
				if (reqLower.indexOf("gifsx") !== -1 || parentLower.indexOf("gifsx") !== -1) {
					process.stderr.write("[ForgeGraal WasmLayer] Polyfilling native @gifsx/gifsx with pure JS stub\\n");
					return {
						Decoder: function () {
							return {
