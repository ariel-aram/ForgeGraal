...
exports.default = new forgescript_1.NativeFunction({
    name: "$compileBinary",
    version: "1.0.0",
    description: "Compiles a bot into a standalone executable or portable bundle and returns its path. Requires `new Graak({ allowCompile: true })`",
    unwrap: true,
    brackets: true,
    ...
    async execute(ctx, [entrypoint, target, output, strategy, pm]) {
        if (!(0, util_1.getGraak)(ctx)?.options.allowCompile) {
        ...
        try {
            const result = await BinaryPackager_1.BinaryPackager.compile({
                entrypoint: (0, util_1.resolveFileArg)(ctx, entrypoint),
                target,
                output: output ? (0, util_1.resolveFileArg)(ctx, output) : undefined,
